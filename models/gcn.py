...
class GCN(nn.Module):
    def __init__(self, adj, input_dim: int, output_dim: int, **kwargs):
        ...
        # self.weights_init = nn.Parameter(
        #     torch.FloatTensor(self._num_nodes*2, self._num_nodes)
        # )
    ...
    def reset_parameters(self):
        # nn.init.xavier_uniform_(self.weights_init, gain=nn.init.calculate_gain("tanh"))
    ...
    def forward(self, inputs):
        ...
        # inputs = inputs.reshape(batch_size, self._input_dim, self._num_nodes*2)
        # inputs = inputs@self.weights_init
